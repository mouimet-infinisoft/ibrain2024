...
// export function ChatStream({ content, conversationId }: ChatStreamProps) {
...
//   //   ) => void = (job, progress) => {
//   //     //@ts-ignore
//   //     if (progress?.payload?.message) {
//   //       //@ts-ignore
//   //       setContent(progress.payload.message);
//   //     }
//   //   };

//   //   taskQueueWorker.on("progress", callback);

//   //   return () => {
//   //     taskQueueWorker.removeListener("progress", callback);
//   //   };
//   // }, []);
