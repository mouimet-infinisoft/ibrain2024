...
//       const messages =  [{
//         role: "system",
//         content: `You received the following notification from yourself and you must inform user about it: ${(task.payload as SendMessagePayload).message}  `
//       }]

//       console.log(messages);
//       // Process immediate response with conditional system prompt
...
//       const codeTask = await createTaskFactory(
//         "GENERATE_CODE",
//         {
...
//         "waiting"
//       );
//       if (codeTask) await enqueueTask(codeTask);
//     }

//     if (analysis.requiresResearch) {
//       const researchTask = await createTaskFactory(
//         "RESEARCH",
//         {
...
//         "waiting"
//       );
//       if (researchTask) await enqueueTask(researchTask);
//     }

//     let systemPrompt = "You are a iBrain One, an AI helpful assistant. ";

//     if (analysis.requiresCode) {
//       systemPrompt += "User asked for code in his message. You respond that you are working on it and it's coming soon. Your response should be short and concise to inform the user that you are working on it but you do not return code directly.";
//     }
