...
// import { streamLLMResponse } from "@/app/protected/chat/lib/ai";
// import { streamLLMResponseToTask } from "@/app/protected/chat/lib/streamLLMResponseToTask";
...
//           const finaleAnswer = await streamLLMResponseToTask(job);

//           logger.verbose(`Final Answer = ${finaleAnswer}`);
//           return finaleAnswer;
//           break;
